...
namespace CourseWork
{
    public partial class Status_projectsForm : MaterialForm
    {
        ...
        private void EditToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Values.StatusProjectId = Convert.ToInt32(dataGridViewStatus_projects.CurrentRow.Cells[0].Value);
            Values.StatusProjectName = Convert.ToString(dataGridViewStatus_projects.CurrentRow.Cells[1].Value);
        ...
        private void dataGridViewStatus_projects_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (Values.AuthRole_user != 2)
                if (e.RowIndex != -1)
                {
                    ...
                    Values.StatusProjectId = Convert.ToInt32(view.Cells[0].Value);
                    Values.StatusProjectName = view.Cells[1].Value.ToString();
